...
async def delete_file(
    ...
    """
    Törli a fájlt az S3-ból vagy lokálisan, ha a felhasználó admin, moderátor, vagy a fájl feltöltője.
    """
    ...
    try:
        ...
        # Fájl törlése (lokálisan vagy S3-ban)
        ...
        # Fájl rekord törlése az adatbázisból
        db.delete(document)
        db.commit()
